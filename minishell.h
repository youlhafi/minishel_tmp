...
/*   Updated: 2023/07/17 18:10:57 by mhabib-a         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char		*ft_strjoinch(const char *s, char c);
...
void		ft_env2(t_list **lst, char **env);
...
void		check_pipe(t_pip *p, t_cmd *cmds, char **envp);
void		exec_cmd(t_pip *p, char *cmd, t_cmd *cmds);
void		ft_exec(t_pip *p, char *cmd, char **envp, t_cmd *cmds);
